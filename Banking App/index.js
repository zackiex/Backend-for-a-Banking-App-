...
var customerAccount = new customer_1.Customer(1, 6000, "Start Compte", 150, "Attia", "Abdelhamid", "Emir Abdelkader", "Bordj bou arriridj", 775404997);
var customerAccount2 = new customer_1.Customer(2, 10000, "Business compte", 168, "Attia", "Zakaria", "Mosbacher Weg", "Görlitz", 1775404997, "zaza@t.vom");
...
var clientToDelet = customers.splice(1, 1);
